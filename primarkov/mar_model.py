...
class MarkovModel:
    ...
    def start_end_trip_distribution_calibration(self):
        print("start_end_trip_distribution_calibration begin has !!!!!")
        ...
        print("start_end_trip_distribution_calibration end has !!!!!")
        for inner_row_index in range(inner_start_index_to_usable.size):
            ...
            print("start_end_trip_distribution_calibration inner_row_index has !!!!!")
    ...
    def model_filtering(self, trajectory_set1: TrajectorySet, grid: Grid):
        print("start_end_trip_distribution_calibration!!!!!!")
        self.start_end_trip_distribution_calibration()
        print("give_level1_length_thresholds!!!!!!")
        self.give_level1_length_thresholds()
        print("get_sensitive_state!!!!!!")
        self.get_sensitive_state()
        print("set_up_guideposts!!!!!!")
        self.set_up_guideposts(grid)
        print("give_guidepost_order2_info!!!!!!")
        self.give_guidepost_order2_info(trajectory_set1)
        print("add_noise_to_guidepost!!!!!!")
        self.add_noise_to_guidepost()
        print("order1_and_2_end_consistency!!!!!!")
        self.order1_and_2_end_consistency()
        print("model_filtering end!!!!!!")
        pass
